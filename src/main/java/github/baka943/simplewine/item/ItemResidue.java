...
public class ItemResidue extends Item {
    public ItemResidue(){
        this.setRegistryName("item_residue");
        this.setUnlocalizedName(SimpleWine.MODID + ".item_residue");
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(I18n.format("tooltips." + SimpleWine.MODID + ".item_residue"));
    }
}
